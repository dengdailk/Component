    ...
    implements IRecommendView
{
    ...
    private void initView() {
        ...
        viewDataBinding.rvDailyView.addItemDecoration(new RecyclerItemDecoration(0,0, DensityUtils.dp2px(Objects.requireNonNull(getContext()),5),DensityUtils.dp2px(getContext(),15)));
